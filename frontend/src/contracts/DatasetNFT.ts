...
export const DATASET_NFT_ABI = [
  ...
  {
    inputs: [],
    name: "claimAllEarningsFromAllTokens",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
    ...
    outputs: [
      {
        ...
        internalType: "struct EnclavaPayments.DatasetNFT",
        name: "",
        type: "tuple",
      },
    ],
...
export const DATASET_NFT_CONTRACT = {
  address: DATASET_NFT_CONTRACT_ADDRESS,
  abi: DATASET_NFT_ABI,
} as const;
